...
\cventry
  ...
  {
    \begin{cvitems}
      \item {Lead a cross-functional squad of 2 senior backend engineers (Golang), focused on delivering features across our financial platform.}
      \item {Define and prioritize sprint objectives in close collaboration with product managers, aligning team goals with broader company OKRs.}
      \item {Remain hands-on: contribute to codebase, perform technical reviews, and guide architectural decisions (\textbf{Golang}, AWS).}
    \end{cvitems}
  }
